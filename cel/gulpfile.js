...
var S = {
  ...
  cqPath: '/content/dam/migration_aem_tr/celtr/fonts_reborn',
  ...
  jsBas: [
    ...
    '../common/src/components/siteHeaderV2/**/*.js',
    ...
    '../common/src/components/btnWrap/**/*.js',
...
// Browser-sync ----------------------------------------
gulp.task('celBrowserSync', ['nodemon'], function(){
